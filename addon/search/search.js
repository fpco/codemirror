...
(function() {
  ...
  function dialog(cm, text, shortText, value, f) {
    if (cm.openDialog) return cm.openDialog(text, f, { keepOpen: true, catchCtrlF: true, value: value });
    else f(prompt(shortText, value));
  }
